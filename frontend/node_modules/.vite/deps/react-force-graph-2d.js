...
import { c as string_default, f as color, l as number_default, o as min$1, r as ordinal, s as max$1, t as require_prop_types, u as rgb_default } from "./prop-types-BE6ZdiqA.js";
...
function index$5(kapsuleComponent) {
	...
	return /* @__PURE__ */ (0, import_react.forwardRef)(function(props, ref) {
		...
		var comp = (0, import_react.useMemo)(function() {
			return kapsuleComponent(Object.fromEntries(initPropNames.filter(function(p) {
		...
		Object.keys(omit(props, [].concat(_toConsumableArray$3(methodNames), _toConsumableArray$3(initPropNames)))).filter(function(p) {
...
function transition_default(name) {
	...
	else id = newId(), (timing = defaultTiming).time = now$2(), name = name == null ? null : name + "";
...
function zoom_default() {
	...
	zoom.wheelDelta = function(_) {
		return arguments.length ? (wheelDelta = typeof _ === "function" ? _ : constant_default$1(+_), zoom) : wheelDelta;
	};
	zoom.filter = function(_) {
		return arguments.length ? (filter = typeof _ === "function" ? _ : constant_default$1(!!_), zoom) : filter;
	};
	zoom.touchable = function(_) {
		return arguments.length ? (touchable = typeof _ === "function" ? _ : constant_default$1(!!_), zoom) : touchable;
	};
	zoom.extent = function(_) {
		return arguments.length ? (extent = typeof _ === "function" ? _ : constant_default$1([[+_[0][0], +_[0][1]], [+_[1][0], +_[1][1]]]), zoom) : extent;
	};
	...
	return _createClass(_default, [
		...
		},
		{
			...
			value: function register(obj) {
				...
				var color = int2HexColor(idx + (checksum(idx, _classPrivateFieldGet2(_csBits, this)) << 24 - _classPrivateFieldGet2(_csBits, this)));
...
}(), n, l, u, t$1, i, r, o, e, f, c$1, s, a$1, h, p, v, d = {}, w = [], _ = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, g = Array.isArray;
function m$1(n, l) {
...
function T(n, l, u, t, i) {
	...
	for (n.__k = new Array(i), r = 0; r < i; r++) null != (o = l[r]) && "boolean" != typeof o && "function" != typeof o ? ("string" == typeof o || "number" == typeof o || "bigint" == typeof o || o.constructor == String ? o = n.__k[r] = x$1(null, o, null, null, null) : g(o) ? o = n.__k[r] = x$1(S, { children: o }, null, null, null) : void 0 === o.constructor && o.__b > 0 ? o = n.__k[r] = x$1(o.type, o.props, o.key, o.ref ? o.ref : null, o.__v) : n.__k[r] = o, f = r + h, o.__ = n, o.__b = n.__b + 1, e = null, -1 != (c = o.__i = O(o, u, f, a)) && (a--, (e = u[c]) && (e.__u |= 2)), null == e || null == e.__v ? (-1 == c && (i > s ? h-- : i < s && h++), "function" != typeof o.type && (o.__u |= 4)) : c != f && (c == f - 1 ? h-- : c == f + 1 ? h++ : (c > f ? h-- : h++, o.__u |= 4))) : n.__k[r] = null;
...
function N(n, l, u, t, i) {
	...
	else if ("o" == l[0] && "n" == l[1]) r = l != (l = l.replace(a$1, "$1")), o = l.toLowerCase(), l = o in n || "onFocusOut" == l || "onFocusIn" == l ? o.slice(2) : l.slice(2), n.l || (n.l = {}), n.l[l + r] = u, u ? t ? u[s] = t[s] : (u[s] = h, n.addEventListener(l, r ? v : p, r)) : n.removeEventListener(l, r ? v : p, r);
	else {
...
function W(l, u, t) {
	...
	return arguments.length > 2 && (f.children = arguments.length > 3 ? n.call(arguments, 2) : t), x$1(l.type, f, i || l.key, r || l.ref, null);
}
...
}, H.__r = 0, f = Math.random().toString(8), c$1 = "__d" + f, s = "__a" + f, a$1 = /(PointerCapture)$|Capture$/i, h = 0, p = V(!1), v = V(!0);
//#endregion
...
var index$2 = index$4({
	...
	init: function init(domNode, state) {
		...
		var el = select_default$1(!!domNode && _typeof$1(domNode) === "object" && !!domNode.node && typeof domNode.node === "function" ? domNode.node() : domNode);
...
function link_default(links) {
	var id = index$1, strength = defaultStrength, strengths, distance = constant_default(30), distances, nodes, nDim, count, bias, random, iterations = 1;
	if (links == null) links = [];
...
var utils = {
	...
	roots: function(points, line) {
		...
		if (order === 2) {
			...
			if (d !== 0) {
				const m1 = -sqrt$1(b * b - a * c), m2 = -a + b;
		...
		if (utils.approximately(d, 0)) {
			...
			const q = sqrt$1(b * b - 4 * a * c), a2 = 2 * a;
		...
		let u1, v1, x1, x2, x3;
		if (discriminant < 0) {
			const mp3 = -p / 3, r = sqrt$1(mp3 * mp3 * mp3), t = -q / (2 * r), phi = acos$1(t < -1 ? -1 : t > 1 ? 1 : t), t1 = 2 * crt(r);
...
**/
var { abs, min, max, cos, sin, acos, sqrt } = Math;
var pi = Math.PI;
/**
...
var Bezier = class Bezier {
	...
	__normal3(t) {
		const r1 = this.derivative(t), r2 = this.derivative(t + .01), q1 = sqrt(r1.x * r1.x + r1.y * r1.y + r1.z * r1.z), q2 = sqrt(r2.x * r2.x + r2.y * r2.y + r2.z * r2.z);
		r1.x /= q1;
		r1.y /= q1;
		r1.z /= q1;
		r2.x /= q2;
...
var forceGraph = index$4({
	...
	init: function init(domNode, state) {
		...
		select_default$1(state.canvas).call(drag_default().subject(function() {
		...
		state.zoom(state.zoom.__baseElem = select_default$1(state.canvas));
...
var ForceGraph2D = index$5(forceGraph, { methodNames: [
	"emitParticle",
	"d3Force",
	"d3ReheatSimulation",
	"stopAnimation",
